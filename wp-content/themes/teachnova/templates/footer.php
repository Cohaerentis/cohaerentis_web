            ...
            <div class="col-lg-3 col-md-3 col-sm-4 col-hs-12 col-xs-12 footer-address-social">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-hs-12 col-xs-12 footer-social">
                        <ul>
                            <li><a href="#" class="glyphicons-social facebook"></a></li>
                            <li><a href="#" class="glyphicons-social twitter"></a></li>
                            <li><a href="#" class="glyphicons-social rss"></a></li>
                        </ul>
                    </div>
                </div>
                <div class="row">
...
<?php /* * / ?>
            ...
            <div class="col-lg-6 col-md-6 hidden-sm hidden-hs hidden-xs footer-left ">
                <div class="row">
